...
exports.getCollectionById = asyncHandler(async (req, res) => {
    ...
    if (!collectionId || !userId) {
        ...
        return helperFunc.sendResponse(res, 400, null, 'Some ID not provided');
    }
    ...
    if (!existingCollection) {
        ...
        return helperFunc.sendResponse(res, 404, null, `Collection with id: ${collectionId} does not exist`);
    }
    // helperFunc.sendResponse(res, 200, existingCollection, null);
    const itemCollection = await getItemCollection([collectionId]);
    helperFunc.sendResponse(res, 200, itemCollection, null);
});
...
exports.getFavouriteCollection = asyncHandler(async (req, res) => {
    ...
    if (!favouriteCollection) {
        ...
        return helperFunc.sendResponse(res, 404, null, `Favourite collection for user with id: ${req.params.id} does not exist`);
    }
...
exports.listCollection = asyncHandler(async (req, res) => {
    ...
    if (!allCollections) {
        ...
        return helperFunc.sendResponse(res, 404, null, `Collections ALL for user with id: ${req.params.id} do not exist`);
    }
    helperFunc.sendResponse(res, 200, allCollections, null);
});
