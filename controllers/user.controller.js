...
exports.getOwnedStamps = asyncHandler(async (req, res) => {
  try {
    ...
    if (result.items.length === 0) {
      return res
        .status(404)
        .json(handleResponse(false, "Owned stamps not found", result));
    }
    return res
      .status(200)
...
exports.getFavouriteStamps = asyncHandler(async (req, res) => {
  try {
    ...
    if (result.items.length === 0) {
      return res
        .status(404)
        .json(handleResponse(false, "Favourite stamps not found", result));
    }
    return res
      .status(200)
  ...
  try {
    ...
    if (userCollection.items.length === 0) {
      return res
        .status(404)
        .json(
          handleResponse(false, "User collections not found", userCollection)
        );
    }
...
exports.getItemsOnSale = asyncHandler(async (req, res) => {
  try {
    ...
    if (itemsOnSale.items.length === 0) {
      return res
        .status(404)
        .json(handleResponse(false, "Items on sale not found", itemsOnSale));
    }
    return res
      .status(200)
      .json(
...
exports.getCart = asyncHandler(async (req, res) => {
  try {
    ...
    if (result.items.length === 0) {
      return res
        .status(404)
        .json(handleResponse(false, "Cart items not found", result));
    }
    return res
      .status(200)
